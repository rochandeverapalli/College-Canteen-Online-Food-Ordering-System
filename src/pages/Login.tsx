...
export const Login: React.FC = () => {
  ...
  // Demo quick-fill credentials for reviewers
      ...
      <div className="w-full max-w-md bg-white rounded-3xl border border-stone-200 shadow-xl p-8 space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-stone-500">
            Sign in to order food, pay online, and get counter pickup tokens
          </p>
        </div>
        ...
        <div className="bg-stone-50 border border-stone-200 rounded-2xl p-3.5 space-y-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="py-1.5 px-2 bg-white border border-stone-200 rounded-xl text-left hover:border-amber-400 transition"
            >
              <div className="text-xs font-bold text-stone-800">Student Demo</div>
              <div className="text-[10px] text-stone-500">student@campus.edu</div>
            </button>
            <button
              type="button"
              onClick={() => handleQuickFill('1808benny@gmail.com', 'admin12345')}
              className="py-1.5 px-2 bg-white border border-amber-300 rounded-xl text-left hover:bg-amber-50 transition"
            >
              <div className="text-xs font-bold text-amber-900">Admin Staff</div>
              <div className="text-[10px] text-stone-500">1808benny@gmail.com</div>
            </button>
          </div>
        </div>
